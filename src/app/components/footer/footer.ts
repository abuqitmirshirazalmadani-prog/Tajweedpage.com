        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div class="flex space-x-4">
              <!-- Social Links -->
              <a href="https://www.facebook.com/profile.php?id=61574326525360" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900 flex items-center justify-center text-emerald-400 hover:bg-emerald-800 hover:text-white transition-colors">
              ...
              <a href="https://www.instagram.com/tajweedpage/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900 flex items-center justify-center text-emerald-400 hover:bg-emerald-800 hover:text-white transition-colors">
              ...
              <a href="https://www.tiktok.com/@tajweedpage" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900 flex items-center justify-center text-emerald-400 hover:bg-emerald-800 hover:text-white transition-colors">
                <span class="sr-only">TikTok</span>
                <svg fill="currentColor" viewBox="0 0 24 24" class="w-5 h-5"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>
              </a>
            </div>
          </div>
